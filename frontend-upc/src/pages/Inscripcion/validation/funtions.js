function dataPersonal(dataPers) {
  ...
  const resultado = {
    ...
    ID_MAD_CAB_HOGAR: madCabHogarMapping[dataPers["¿Es Madre o Padre Cabeza de hogar?"]],
    ...
    ID_POS_HERMANO: dataPers["¿Posicion entre hermanos?"],
    ID_INTEGRANTES: dataPers["Integrantes de su familia"],
