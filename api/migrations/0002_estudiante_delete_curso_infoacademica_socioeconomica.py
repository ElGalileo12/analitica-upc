...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='InfoAcademica',
            fields=[
                ('ID_ESTUDIANTE', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='api.estudiante')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ID_INGRESO_FAMILIAR', models.DecimalField(decimal_places=2, max_digits=10)),
